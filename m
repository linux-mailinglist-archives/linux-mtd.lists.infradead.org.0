...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 91DC1141394
	for <lists+linux-mtd@lfdr.de>; Fri, 17 Jan 2020 22:46:58 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=c4ViWu8USXMoif5WOnuwoL2qyTL8WImVr9Sl+62wqPk=; b=IS6DhOo/YqtXbF
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1isZS1-0005o1-F8; Fri, 17 Jan 2020 21:46:45 +0000
...
Received: from xps13.lan (unknown [91.224.148.103])
 ...
 by relay10.mail.gandi.net (Postfix) with ESMTPSA id 3C330240006;
 Fri, 17 Jan 2020 21:42:21 +0000 (UTC)
From: Miquel Raynal <miquel.raynal@bootlin.com>
To: Richard Weinberger <richard@nod.at>, Vignesh Raghavendra <vigneshr@ti.com>,
 Tudor Ambarus <Tudor.Ambarus@microchip.com>,
 <linux-mtd@lists.infradead.org>
Subject: [PATCH v4 11/21] mtd: rawnand: Use the new ECC engine type enumeration
Date: Fri, 17 Jan 2020 22:41:41 +0100
Message-Id: <20200117214151.20767-12-miquel.raynal@bootlin.com>
...
X-CRM114-CacheID: sfid-20200117_134224_302674_4C03F4CD 
...
---
 ...
 78 files changed, 221 insertions(+), 206 deletions(-)
...
index 150a36f333df..8d2f6ac3d862 100644
...
index 9d87d4e440ea..ecff862f8c4d 100644
...
index 29f9b345a531..3e0f18501154 100644
...
index bfe9881d12cc..66a7a520ff09 100644
...
index 8312182088c1..eee7f0db586a 100644
...
index 8d6be90a6fe8..346275693661 100644
...
index e10b76089048..5124b325f629 100644
...
index 1a66b1cd51c0..14649c0cd3ca 100644
--- a/drivers/mtd/nand/raw/brcmnand/brcmnand.c
+++ b/drivers/mtd/nand/raw/brcmnand/brcmnand.c
@@ -2253,9 +2253,9 @@ static int brcmnand_setup_dev(struct brcmnand_host *host)
 	cfg->col_adr_bytes = 2;
...
@@ -2275,7 +2275,7 @@ static int brcmnand_setup_dev(struct brcmnand_host *host)
 		return -EINVAL;
 	}
...
@@ -2416,7 +2416,7 @@ static int brcmnand_init_cs(struct brcmnand_host *host, struct device_node *dn)
...
index f6c7102a1e32..291acf7a3e33 100644
--- a/drivers/mtd/nand/raw/cadence-nand-controller.c
+++ b/drivers/mtd/nand/raw/cadence-nand-controller.c
@@ -2598,7 +2598,7 @@ int cadence_nand_attach_chip(struct nand_chip *chip)
...
@@ -2748,7 +2748,7 @@ static int cadence_nand_chip_init(struct cdns_nand_ctrl *cdns_ctrl,
...
index 82b4da780b8d..c323c0a7fb36 100644
...
index e2322cee3229..8faa91f6622f 100644
...
index 3ca210bf09d1..dda7834b582b 100644
...
index b4a4ea5e7565..4f6a7778203b 100644
...
index 41cc7e04679d..fbae5fb33caa 100644
...
index 634c550db13a..f96f105362fe 100644
...
@@ -728,12 +728,12 @@ static int fsl_elbc_attach_chip(struct nand_chip *chip)
...
@@ -787,8 +787,8 @@ static int fsl_elbc_attach_chip(struct nand_chip *chip)
 	        chip->page_shift);
...
index 1054cc070747..b2a0c5f2927a 100644
...
index a6964feeec77..91b68b083b06 100644
--- a/drivers/mtd/nand/raw/fsmc_nand.c
+++ b/drivers/mtd/nand/raw/fsmc_nand.c
@@ -896,8 +896,8 @@ static int fsmc_nand_attach_chip(struct nand_chip *nand)
 		return 0;
 	}
...
index 334fe3130285..2709105142d3 100644
...
index 49afebee50db..696f44d9c65c 100644
...
index fb5abdcfb007..6ea350acb05d 100644
...
index 9f17b5b8efbf..d2e8217e84ea 100644
...
index 8b90def6686f..e8d4b3e703bf 100644
...
index b8305e39ab51..ab545befd6c8 100644
...
index 21e7e35a8f5f..c4f5b0ac92be 100644
--- a/drivers/mtd/nand/raw/nand_base.c
+++ b/drivers/mtd/nand/raw/nand_base.c
@@ -4786,28 +4786,35 @@ static const char * const nand_ecc_placement[] = {
...
@@ -4917,8 +4924,9 @@ static bool of_get_nand_on_flash_bbt(struct device_node *np)
...
+	int ecc_strength, ecc_step;
 	...
 	if (!dn)
 		return 0;
@@ -4932,14 +4940,14 @@ static int nand_dt_init(struct nand_chip *chip)
...
@@ -5061,7 +5069,7 @@ static int nand_set_ecc_soft_ops(struct nand_chip *chip)
...
+	if (WARN_ON(ecc->engine_type != NAND_ECC_ENGINE_SOFT))
 	...
 	switch (ecc->algo) {
@@ -5522,7 +5530,8 @@ static int nand_scan_tail(struct nand_chip *chip)
...
+	      ecc->algo == NAND_ECC_BCH)) {
 		...
 		case 8:
 		case 16:
@@ -5540,7 +5549,7 @@ static int nand_scan_tail(struct nand_chip *chip)
...
+			if (ecc->engine_type == NAND_ECC_ENGINE_NONE) {
 				...
 				break;
@@ -5558,8 +5567,8 @@ static int nand_scan_tail(struct nand_chip *chip)
...
@@ -5616,12 +5625,12 @@ static int nand_scan_tail(struct nand_chip *chip)
 			}
...
+	case NAND_ECC_ENGINE_SOFT:
 		...
 		if (ret) {
 			ret = -EINVAL;
@@ -5629,7 +5638,7 @@ static int nand_scan_tail(struct nand_chip *chip)
 		}
 		break;
...
+	case NAND_ECC_ENGINE_ON_DIE:
 		if (!ecc->read_page || !ecc->write_page) {
 			...
 			ret = -EINVAL;
@@ -5641,8 +5650,8 @@ static int nand_scan_tail(struct nand_chip *chip)
...
@@ -5655,7 +5664,7 @@ static int nand_scan_tail(struct nand_chip *chip)
 		break;
...
@@ -5730,8 +5739,8 @@ static int nand_scan_tail(struct nand_chip *chip)
...
+	case NAND_ECC_ENGINE_SOFT:
 		...
 		break;
@@ -5873,7 +5882,7 @@ EXPORT_SYMBOL(nand_scan_with_ids);
  */
...
index 56654030ec7f..235f0b965df6 100644
...
index 9c03fbb1f47d..11f7a496c1ae 100644
--- a/drivers/mtd/nand/raw/nand_toshiba.c
+++ b/drivers/mtd/nand/raw/nand_toshiba.c
@@ -146,7 +146,8 @@ static int toshiba_nand_init(struct nand_chip *chip)
...
index 9a70754a61ef..6838bec6537e 100644
...
index 7bb9a7e8e1e7..d5514baca08e 100644
...
index 3ba73f18841f..23ebd87181da 100644
...
index 37a4ac0dd85b..5038d5a76a9a 100644
...
index 9acf2de37ee0..b760b3fd3f9d 100644
...
index 3cc9a4c41443..8fb4e06047a0 100644
...
index 6b399a75f9ae..b90eb5d342c8 100644
...
index aeef31a68c7a..717669db7b10 100644
--- a/include/linux/mtd/rawnand.h
+++ b/include/linux/mtd/rawnand.h
@@ -327,7 +327,7 @@ static const struct nand_ecc_caps __name = {			\
...
@@ -380,7 +380,7 @@ static const struct nand_ecc_caps __name = {			\
