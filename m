...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C4E3E9EE5
	for <lists+linux-mtd@lfdr.de>; Wed, 30 Oct 2019 16:27:38 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=RNu6wunW2Z/KqRoYpI9I0rjd0LqObDK7xDAicVlDGro=; b=s8TZ6LovqFzTjY
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iPpsm-0005i6-OE; Wed, 30 Oct 2019 15:27:36 +0000
Received: from metis.ext.pengutronix.de ([2001:67c:670:201:290:27ff:fe1d:cc33])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iPpsI-0005Vs-JN
 for linux-mtd@lists.infradead.org; Wed, 30 Oct 2019 15:27:10 +0000
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
 by metis.ext.pengutronix.de with esmtps
 (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256) (Exim 4.92)
 (envelope-from <sha@pengutronix.de>)
 id 1iPpsH-0003Y8-AK; Wed, 30 Oct 2019 16:27:05 +0100
Received: from sha by dude.hi.pengutronix.de with local (Exim 4.92)
 (envelope-from <sha@pengutronix.de>)
 id 1iPpsG-0005nV-1K; Wed, 30 Oct 2019 16:27:04 +0100
From: Sascha Hauer <s.hauer@pengutronix.de>
To: linux-fsdevel@vger.kernel.org
Subject: [PATCH 10/10] ubifs: Add quota support
Date: Wed, 30 Oct 2019 16:27:02 +0100
Message-Id: <20191030152702.14269-11-s.hauer@pengutronix.de>
...
X-CRM114-CacheID: sfid-20191030_082706_993413_2B7F5811 
...
---
 ...
 11 files changed, 828 insertions(+), 5 deletions(-)
...
index 92a782f3fdc2..d812b16e25f7 100644
--- a/fs/ubifs/ioctl.c
+++ b/fs/ubifs/ioctl.c
...
index 000000000000..82aa1f067825
--- /dev/null
+++ b/fs/ubifs/quota.c
@@ -0,0 +1,609 @@
...
+			continue;
+
+		ret = dquot_enable_sb(sb, type, QFMT_UBIFS,
