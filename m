...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 319311E5A1C
	for <lists+linux-mtd@lfdr.de>; Thu, 28 May 2020 10:00:20 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=2JVpETU2e0E6+Q9khmZmH8lDkAVpdL8dziImZ7XxQb4=; b=qT8v46j899Z9EHwCF+3nhSmkEm
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jeDSY-0008I5-8H; Thu, 28 May 2020 08:00:14 +0000
Received: from twhmllg4.macronix.com ([211.75.127.132])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jeDRI-0007Wy-Qw
 for linux-mtd@lists.infradead.org; Thu, 28 May 2020 07:59:00 +0000
Received: from localhost.localdomain ([172.17.195.96])
 by TWHMLLG4.macronix.com with ESMTP id 04S7wMHc030973;
 Thu, 28 May 2020 15:58:25 +0800 (GMT-8)
...
Subject: [PATCH v3 03/14] mtd: spi-nor: add support for DTR protocol
Date: Thu, 28 May 2020 15:58:05 +0800
Message-Id: <1590652696-8844-4-git-send-email-masonccyang@mxic.com.tw>
...
X-MAIL: TWHMLLG4.macronix.com 04S7wMHc030973
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200528_005857_123368_7F99A825 
...
@@ -2368,12 +2517,16 @@ static int spi_nor_spimem_check_pp(struct spi_nor *nor,
...
@@ -2774,12 +2927,26 @@ static void spi_nor_info_init_params(struct spi_nor *nor)
 					  SNOR_PROTO_1_1_8);
 	}
...
@@ -399,6 +402,9 @@ struct spi_nor_manufacturer {
...
+
  ...
  * drivers.
@@ -345,6 +368,7 @@ struct spi_nor_controller_ops {
