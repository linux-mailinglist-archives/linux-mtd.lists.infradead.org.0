...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EBFE46239
	for <lists+linux-mtd@lfdr.de>; Fri, 14 Jun 2019 17:11:39 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=L9YK9PCTiXGaiQtzxkMN919nghtan7tON/6LZqBOm4o=; b=c4iLCT2Dny7HGA
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hbnra-0008EA-6g; Fri, 14 Jun 2019 15:11:34 +0000
Received: from mx0b-0014ca01.pphosted.com ([208.86.201.193]
 helo=mx0a-0014ca01.pphosted.com)
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1hbnrF-0008Cd-Bh
 for linux-mtd@lists.infradead.org; Fri, 14 Jun 2019 15:11:19 +0000
Received: from pps.filterd (m0042333.ppops.net [127.0.0.1])
 by mx0b-0014ca01.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x5EF4HSr022912; Fri, 14 Jun 2019 08:10:50 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=proofpoint;
 bh=aX3yPhIChOyuY5C1nHMhy0N9KtTgel5gu8gr2ATp/js=;
 b= Zg== 
...
Received: from nam01-bn3-obe.outbound.protection.outlook.com
 ...
 by mx0b-0014ca01.pphosted.com with ESMTP id 2t3qr0ncph-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT);
 Fri, 14 Jun 2019 08:10:50 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com;
 s=selector1;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=aX3yPhIChOyuY5C1nHMhy0N9KtTgel5gu8gr2ATp/js=;
 b=kQGhZ5rw6Ij9VTdfeon7mE5hv34Sp72kfi50HdyQUPbZbpZeOntyYrDQAtroZCrowypZJMKMoyIjfUCq7Dl+4hBcc+51SR60isM628Stm49b1CUyz+jXsc17kqBpe/q9EtJnu4lzESXf8qWSsuAEP9HbTb7rPhP3eFWpBDoyfPc=
Received: from BYAPR07CA0068.namprd07.prod.outlook.com (2603:10b6:a03:60::45)
 by AT5SPR00MB0007.namprd07.prod.outlook.com (2a01:111:e400:7427::23)
 with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.1987.12; Fri, 14 Jun
 2019 15:10:46 +0000
Received: from BY2NAM05FT026.eop-nam05.prod.protection.outlook.com
 (2a01:111:f400:7e52::203) by BYAPR07CA0068.outlook.office365.com
 ...
 Transport; Fri, 14 Jun 2019 15:10:46 +0000
Received-SPF: SoftFail (protection.outlook.com: domain of transitioning
 cadence.com discourages use of 158.140.1.28 as permitted sender)
Received: from sjmaillnx2.cadence.com (158.140.1.28) by
 BY2NAM05FT026.mail.protection.outlook.com (10.152.100.163) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.20.2008.7 via Frontend Transport; Fri, 14 Jun 2019 15:10:45 +0000
Received: from maileu3.global.cadence.com (maileu3.cadence.com [10.160.88.99])
 by sjmaillnx2.cadence.com (8.14.4/8.14.4) with ESMTP id
 x5EFAeFH026015
 (version=TLSv1/SSLv3 cipher=AES256-SHA bits=256 verify=OK);
 Fri, 14 Jun 2019 08:10:42 -0700
X-CrossPremisesHeadersFilteredBySendConnector: maileu3.global.cadence.com
Received: from maileu3.global.cadence.com (10.160.88.99) by
 maileu3.global.cadence.com (10.160.88.99) with Microsoft SMTP Server (TLS) id
 15.0.1367.3; Fri, 14 Jun 2019 17:10:40 +0200
Received: from lvlogina.cadence.com (10.165.176.102) by
 maileu3.global.cadence.com (10.160.88.99) with Microsoft SMTP Server (TLS) id
 15.0.1367.3 via Frontend Transport; Fri, 14 Jun 2019 17:10:39 +0200
Received: from lvlogina.cadence.com (localhost.localdomain [127.0.0.1])
 by lvlogina.cadence.com (8.14.4/8.14.4) with ESMTP id x5EFAdMo032009;
 Fri, 14 Jun 2019 16:10:39 +0100
Received: (from piotrs@localhost)
 by lvlogina.cadence.com (8.14.4/8.14.4/Submit) id x5EFAdLI032008;
 Fri, 14 Jun 2019 16:10:39 +0100
From: Piotr Sroka <piotrs@cadence.com>
To: <linux-kernel@vger.kernel.org>
Subject: [v3 1/2] mtd: nand: Add Cadence NAND controller driver
Date: Fri, 14 Jun 2019 16:09:56 +0100
Message-ID: <20190614150956.31244-1-piotrs@cadence.com>
X-Mailer: git-send-email 2.15.0
In-Reply-To: <20190614150638.28383-1-piotrs@cadence.com>
...
X-Forefront-Antispam-Report: CIP:158.140.1.28; IPV:CAL; SCL:-1; CTRY:US;
 EFV:NLI; SFV:NSPM;
 SFS:(10009020)(136003)(39860400002)(346002)(396003)(376002)(2980300002)(189003)(43544003)(199004)(36092001)(2351001)(86362001)(11346002)(16586007)(8936002)(336012)(54906003)(486006)(126002)(476003)(305945005)(6666004)(446003)(356004)(2616005)(426003)(4326008)(6916009)(246002)(8676002)(186003)(107886003)(50226002)(7636002)(70206006)(70586007)(316002)(50466002)(7416002)(42186006)(36756003)(5660300002)(2906002)(51416003)(48376002)(87636003)(1076003)(478600001)(47776003)(30864003)(53946003)(14444005)(5024004)(26005)(19627235002)(26826003)(76130400001)(76176011)(579004)(559001)(569006);
 DIR:OUT; SFP:1101; SCL:1; SRVR:AT5SPR00MB0007; H:sjmaillnx2.cadence.com; FPR:;
 SPF:SoftFail; LANG:en; PTR:corp.Cadence.COM; MX:1; A:1; 
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 5bb942b6-7446-4359-735d-08d6f0da79ee
X-Microsoft-Antispam: BCL:0; PCL:0;
 ...
 SRVR:AT5SPR00MB0007; 
X-MS-TrafficTypeDiagnostic: AT5SPR00MB0007:
X-Microsoft-Antispam-PRVS: <AT5SPR00MB0007554B20BB5B63F79CF456DDEE0@AT5SPR00MB0007.namprd07.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:8882;
X-Forefront-PRVS: 0068C7E410
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam-Message-Info: 
X-OriginatorOrg: cadence.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Jun 2019 15:10:45.7800 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 5bb942b6-7446-4359-735d-08d6f0da79ee
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: AT5SPR00MB0007
...
X-CRM114-CacheID: sfid-20190614_081113_672200_BD505B58 
...
index 000000000000..6c6f515e424a
--- /dev/null
...
+	case TT_OOB_AREA:
+		offset = mtd->writesize - cdns_chip->sector_size;
...
+						  + chip->ecc.bytes);
+	bbm_offset = mtd->writesize - bbm_offset + cdns_chip->bbm_offs;
+
+	/*
...
+						       cdns_chip->bbm_offs));
+
+	cadence_nand_prepare_data_size(chip, TT_OOB_AREA);
+
...
+	 * If clk_period is 50ns (the lowest value) this contition is met
+	 * for asynchronous timing modes 1, 2, 3, 4 and 5.
+	 * If clk_period is 20ns the contition is met only
...
+				   "cdns,board-delay_ps", &val);
+	if (ret) {
+		dev_warn(cdns_ctrl->dev, "missing cdns,board-delay_ps property\n");
+		val = 0;
+	}
